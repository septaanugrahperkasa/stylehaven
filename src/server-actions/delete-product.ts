...
export async function deleteFromCart({ product_id }: { product_id: string }) {
  ...
  try {
    ...
    const [{ product_id: deletedProductId, cart_id: cartId, quantity }] =
      await db
